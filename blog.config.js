...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1311d8aa36098068a2ecd7d0e12118fb,we:1311d8aa3609806dbef8e1abd278c735',
  THEME: process.env.NEXT_PUBLIC_THEME || 'me', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://oval-kitty-0c9.notion.site/1311d8aa360981698727d0eda32e01a2?source=copy_link', // 网站地址
